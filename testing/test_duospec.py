...
from algorithms.duo_spec import duo_spec, detection_stats, get_true_communities, bethe_hessian
...
def run_experiments():
    ...
    for idx, sigma in enumerate(sigma_values):
        ...
        for i in range(runs):
            ...
            # 1) duo_spec with motif_spectral_embedding
            try:
                ...
                results['duo_spec_motif'] = {'stats': stats, 'preds': preds}
            except Exception as e:
                results['duo_spec_motif'] = {'error': str(e)}
            
            # 2) duo_spec with bethe_hessian
            try:
            ...
            try: 
                ...
                results['CONTROL_motif_counting'] = {'error': str(e)}
            ...
            with open(os.path.join(out_dir, fname), 'w') as f:
                json.dump(output, f, default=lambda o: o.tolist() if hasattr(o, 'tolist') else str(o))
