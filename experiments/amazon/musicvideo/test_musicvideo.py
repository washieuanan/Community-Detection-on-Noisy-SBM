...
def sample_components_and_connect(G: nx.Graph, target_per_comm: int = 5000, tolerance: int = 500, seed: int = 0, attr: str = "comm"):
    """
    Select connected components of similar sizes to target_per_comm (±tolerance) per community,
    then connect them if needed.
...
if __name__ == "__main__":
    graph_name = "musicvideo"
    comm_pair = ["Music", "Video"]
    print(f"\n{'='*60}")
